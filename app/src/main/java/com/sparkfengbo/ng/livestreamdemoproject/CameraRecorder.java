...
public class CameraRecorder extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public CameraRecorder(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CameraRecorder(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                mCameraDataCallback.onPreviewData(data, data.length, mRotate);
//            }
        }
    };
