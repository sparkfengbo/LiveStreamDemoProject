...
FDK_INCLUDE=$basepath/fdk-aac-0.1.4/android/$CPU/include

FDK_LIB=$basepath/fdk-aac-0.1.4/android/$CPU/lib

X264_INCLUDE=$basepath/x264-snapshot-20140916-2245-stable/android/$CPU/include
